...
export function getRoles(scale: number): Role[] {
  ...
  return [
    ...
    },
    {
      ...
      summary: 'Patient visits, treatment services, procedures, and EBOO clearances under the provider.',
      source: 'ECW',
      headcount: 1,
      metrics: [
        { label: 'Patients seen', value: r(386), format: 'number' },
        { label: 'Treatment services', value: r(164), format: 'number' },
    ...
    },
    {
      ...
      summary: 'Vitals, visits, injections, messages, and care plans.',
      source: 'ECW',
      headcount: 2,
      metrics: [
        { label: 'Vitals taken', value: r(2_310), format: 'number' },
        { label: 'Visits', value: r(1_140), format: 'number' },
...
const EMPLOYEE_SEEDS: EmployeeSeed[] = [
  ...
  { id: 'e3', name: 'Brooke', role: 'Physician Associate', roleId: 'pa', utilizationPct: 91, revenue: 58_200, metrics: [
    ...
    { label: 'Treatment services', value: 164, format: 'number' },
  ...
  { id: 'e8', name: 'Charlene (Virtual)', role: 'Medical Assistant', roleId: 'ma', utilizationPct: 91, revenue: 14_200, metrics: [
    ...
    { label: 'Visits', value: 610, format: 'number' },
  ...
  { id: 'e9', name: 'Wesley', role: 'Medical Assistant', roleId: 'ma', utilizationPct: 88, revenue: 12_800, metrics: [
    ...
    { label: 'Visits', value: 530, format: 'number' },
